...
from batch_processor.monitoring import logger, record_error, PREDICTIONS_MADE_TOTAL, CUSTOM_ERROR_TYPE_TOTAL
...
class ModelPredictor:
    ...
    def _load_model(self):
        try:
            ...
            CUSTOM_ERROR_TYPE_TOTAL.labels(custom_error_type="model_load_failure").inc()
    ...
    def predict(self, features_df: pd.DataFrame):
        if self.model is None:
            ...
            CUSTOM_ERROR_TYPE_TOTAL.labels(custom_error_type="model_not_loaded").inc()
        ...
        if not isinstance(features_df, pd.DataFrame):
            ...
            CUSTOM_ERROR_TYPE_TOTAL.labels(custom_error_type="prediction_input_error").inc()
            return [], []
        ...
        try:
            ...
            CUSTOM_ERROR_TYPE_TOTAL.labels(custom_error_type="prediction_runtime_error").inc()
            return [], [] 